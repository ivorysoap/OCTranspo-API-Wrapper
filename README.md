...
This is a wrapper for the OC Transpo API that provides the user more readability and ease of use than interfacing with the API directly.  Instead of messing around with oddly-formed GET requests, why not just call the API from your terminal and get real-time transit data at your fingertips - for any bus stop in Ottawa?
